    ...
    $(function() {
        ...
        let modal = function() {
            let $trigger = $('.trigger'),
                ...
                $modal = $('.modal');
            let template = {
                img: (img) => '<div class="modal">' + '<div class="modal-window">' + '<a href="#" class="modal-close fa fa-close"></a>' + '<img src="' + img + '" />' + '</div>' + '</div>'
            };
            return {
                refresh: function() {},
                init: function() {
            ...
            return {
                init: function() {
                    ...
                    $('#submitPhone').on('click', function() {
                        var $this = $(this),
                            $row = $this.closest('.form-group_row'),
                            data = {
                                contact: $row.find('.form-input_phone').val()
                            };
                    ...
                    $('#submitMail').on('click', function() {
                        var $this = $(this),
                            $row = $this.closest('.form-group_row'),
                            data = {
                                contact: $row.find('.form-input_mail').val()
                            };
                        postData('/requestContactConfirmation', data, function(result) {
                            if (result.result) {
                    ...
                    $sendButton.on('click', function(e) {
                        ...
                        var $this = $(this);
                        var $thisStep = $this.closest($LoginStep),
                            $validate = $thisStep.find('[data-validate]'),
                            error = false;
                        $validate.each(function() {
                            var $this = $(this);
                            $this.trigger('blur');
